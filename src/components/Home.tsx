  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="flex gap-4 mb-8 items-center">
        {techButtons.map(({ title, tech, color, logo, alt, padding }, index) => (
          <button
            key={index}
            className={`flex items-center gap-3 ${padding} ${color} text-white rounded-lg transition transform hover:scale-105 ${currentTech === tech ? "border-b-4 border-grey" : ""}`}
